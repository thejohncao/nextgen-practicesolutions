...
const TabNavigation = ({ agents, activeTab, setActiveTab, className }: TabNavigationProps) => {
  return (
    <div className={cn("relative flex justify-center mb-6", className)}>
      ...
      <div className="relative z-10 w-full max-w-3xl">
        ...
        <div className="absolute inset-0 rounded-xl bg-black/90 blur-md -z-10 transform scale-y-[0.85] scale-x-[1.02] translate-y-1"></div>
        ...
        <div className="relative">
          ...
          <div className="relative rounded-xl rounded-tl-none overflow-hidden bg-[#111827]/95 border border-white/10 shadow-xl">
            {/* Folder Icon */}
            ...
            <div className={`absolute h-0.5 top-0 left-0 transition-all duration-300 ${
