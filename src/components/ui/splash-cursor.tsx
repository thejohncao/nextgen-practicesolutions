...
interface SplashCursorProps extends React.HTMLAttributes<HTMLCanvasElement> {
...
const SplashCursor = React.forwardRef<HTMLCanvasElement, SplashCursorProps>(
  ({ 
    className,
    simResolution = 128,
    dyeResolution = 1440,
    ...
    const finalRef = (ref || canvasRef) as React.RefObject<HTMLCanvasElement>;
    ...
    React.useEffect(() => {
      ...
      function resizeFBO(target, w, h, internalFormat, format, type, filtering) {
        let newFBO = createFBO(w, h, internalFormat, format, type, filtering);
        copyProgram.bind();
      ...
      function getResolution(resolution) {
        ...
        if (aspectRatio < 1) aspectRatio = 1.0;
        let w = resolution;
