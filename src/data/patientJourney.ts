...
export const patientJourney: JourneyStage[] = [
  {
    number: '01',
    name: 'Attract & Engage',
    gradientClass: 'bg-gradient-to-br from-blue-50/5 to-blue-100/10',
  ...
  },
  {
    ...
    gradientClass: 'bg-gradient-to-br from-green-50/5 to-green-100/10',
  ...
  },
  {
    number: '03',
    name: 'Accept & Onboard',
    gradientClass: 'bg-gradient-to-br from-purple-50/5 to-purple-100/10',
  ...
  },
  {
    number: '04',
    name: 'Retain & Grow',
    gradientClass: 'bg-gradient-to-br from-amber-50/5 to-amber-100/10',
